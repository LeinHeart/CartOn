...
class PostList{
    ...
    init(){
        ...
        //71-80
        uploadList.append(PostClass(uploaderName: "John Doe", imageTitle: "Power Angel", imageDescription: "Recreating Angel with Mecha.", tags: ["Mecha","Gundam","Angel","Wings", "White"], likeCount: 112, image:"71"))
        uploadList.append(PostClass(uploaderName: "Bachtiar", imageTitle: "Sharp Plate", imageDescription: "Medivial Full Plate", tags: ["Armor","Dark","Medivial"], likeCount: 97, image:"72"))
        uploadList.append(PostClass(uploaderName: "Ph!l", imageTitle: "Million Chain 'Averu'", imageDescription: "I made Angel with Gundam Version.", tags: ["Gundam","Angel","Mecha"], likeCount: 90, image:"73"))
        uploadList.append(PostClass(uploaderName: "John Doe", imageTitle: "Auroras", imageDescription: "Female Assassin Mecha", tags: ["Assassin","Mecha","Pink","Wings"], likeCount: 100, image:"74"))
        uploadList.append(PostClass(uploaderName: "Firdenon", imageTitle: "GxG Blade", imageDescription: "Combine Assassin and Samurai", tags: ["Samurai","Assassin","Mecha"], likeCount: 78, image:"75"))
        uploadList.append(PostClass(uploaderName: "Nyunyud", imageTitle: "Zero", imageDescription: "A Swordman with Blade", tags: ["Swordman","Fantasy","RPG"], likeCount: 100, image:"76"))
        uploadList.append(PostClass(uploaderName: "Shiro00", imageTitle: "Foxy", imageDescription: "Personification of Fox being a Warrior", tags: ["Fox","Warrior","Sword"], likeCount: 82, image:"77"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "Devilia", imageDescription: "a cute Devil ready to fight~", tags: ["Devil","Wings","Cute"], likeCount: 120, image:"78"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "Chocolate 'Maid'", imageDescription: "Maid with Nekomimi Ready to serve you master!", tags: ["Maid","Cat Ears","Cute"], likeCount: 110, image:"79"))
        uploadList.append(PostClass(uploaderName: "Hideki", imageTitle: "グリムノーツ", imageDescription: "Appreantice Magician", tags: ["Magician","Cute","Card"], likeCount: 92, image:"80"))
        //81-90
        uploadList.append(PostClass(uploaderName: "Ghalax", imageTitle: "InsFire", imageDescription: "Warrior come straight from hell", tags: ["Dark","Sword","Hell"], likeCount: 120, image:"81"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "Dark Creature", imageDescription: "My version of Creature from Darkness", tags: ["Dark","Creature","Scythe"], likeCount: 151, image:"82"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "Phantom", imageDescription: "Dual-Wielder Fighter from Darkness", tags: ["Darkness","Dual Sword","Creepy"], likeCount: 137, image:"83"))
        uploadList.append(PostClass(uploaderName: "Tasikumase", imageTitle: "Wizard", imageDescription: "Wizard with Fighting Type", tags: ["Wizard","Staff","Scythe"], likeCount: 120, image:"84"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "Mago Energetico", imageDescription: "Ice-Type Magician", tags: ["Magician","Ice","Staff"], likeCount: 123, image:"85"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "Obraztof", imageDescription: "Magician that already reach high tier", tags: ["Magician","Cool","Hand"], likeCount: 140, image:"86"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "이승희(Seung Hee Lee)", imageDescription: "Original Character inspired from Dark Knight", tags: ["Knight","Gloom","Shadow"], likeCount: 120, image:"87"))
        uploadList.append(PostClass(uploaderName: "C0l", imageTitle: "Armadura :Colecionador de Ossos", imageDescription: "Warrior with many weapons", tags: ["Warrior","Sword","Spear"], likeCount: 150, image:"88"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "Archangle", imageDescription: "Archangel ready to Battle", tags: ["Archangel","Wings","Sword"], likeCount: 144, image:"89"))
        uploadList.append(PostClass(uploaderName: "L0nT", imageTitle: "Izrail ", imageDescription: "Azrael es el Arcángel de la Muerte en varias tradiciones extrabíblicas. Está presente en el sijismo, en el islamismo, en el cristianismo e incluso en el judaísmo. Su nombre deriva de “Izrail”, nombre presente en el Corán y que se traduce como “Quien a Dios ayuda”.", tags: ["Devil","Scythe","Dark"], likeCount: 130, image:"90"))
        //91-100
        uploadList.append(PostClass(uploaderName: "John Doe", imageTitle: "Power Angel", imageDescription: "Recreating Angel with Mecha.", tags: ["Mecha","Gundam","Angel","Wings", "White"], likeCount: 112, image:"91"))
        uploadList.append(PostClass(uploaderName: "Bachtiar", imageTitle: "Sharp Plate", imageDescription: "Medivial Full Plate", tags: ["Armor","Dark","Medivial"], likeCount: 97, image:"92"))
        uploadList.append(PostClass(uploaderName: "Ph!l", imageTitle: "Million Chain 'Averu'", imageDescription: "I made Angel with Gundam Version.", tags: ["Gundam","Angel","Mecha"], likeCount: 90, image:"93"))
        uploadList.append(PostClass(uploaderName: "John Doe", imageTitle: "Auroras", imageDescription: "Female Assassin Mecha", tags: ["Assassin","Mecha","Pink","Wings"], likeCount: 100, image:"94"))
        uploadList.append(PostClass(uploaderName: "Firdenon", imageTitle: "GxG Blade", imageDescription: "Combine Assassin and Samurai", tags: ["Samurai","Assassin","Mecha"], likeCount: 78, image:"95"))
        uploadList.append(PostClass(uploaderName: "Nyunyud", imageTitle: "Zero", imageDescription: "A Swordman with Blade", tags: ["Swordman","Fantasy","RPG"], likeCount: 100, image:"96"))
        uploadList.append(PostClass(uploaderName: "Shiro00", imageTitle: "Foxy", imageDescription: "Personification of Fox being a Warrior", tags: ["Fox","Warrior","Sword"], likeCount: 82, image:"97"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "Devilia", imageDescription: "a cute Devil ready to fight~", tags: ["Devil","Wings","Cute"], likeCount: 120, image:"98"))
        uploadList.append(PostClass(uploaderName: "LeinHeart", imageTitle: "Chocolate 'Maid'", imageDescription: "Maid with Nekomimi Ready to serve you master!", tags: ["Maid","Cat Ears","Cute"], likeCount: 110, image:"99"))
        uploadList.append(PostClass(uploaderName: "Hideki", imageTitle: "グリムノーツ", imageDescription: "Appreantice Magician", tags: ["Magician","Cute","Card"], likeCount: 92, image:"100"))
