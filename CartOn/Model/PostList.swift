...
class PostList{
    ...
    init(){
        ...
        uploadList.append(PostClass(uploaderName: "Firdenon", imageTitle: "GxG Blade", imageDescription: "Combine Assassin and Samurai", tags: ["Samurai","Assassin","Mecha"], likeCount: 0, image:"5"))
        ...
        uploadList.append(PostClass(uploaderName: "Firdenon", imageTitle: "GxG Blade", imageDescription: "Combine Assassin and Samurai", tags: ["Samurai","Assassin","Mecha"], likeCount: 0, image:"25"))
        ...
        uploadList.append(PostClass(uploaderName: "Firdenon", imageTitle: "GxG Blade", imageDescription: "Combine Assassin and Samurai", tags: ["Samurai","Assassin","Mecha"], likeCount: 0, image:"45"))
        ...
        uploadList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Auroras", imageDescription: "Female Assassin Mecha", tags: ["Assassin","Mecha","Pink","Wings"], likeCount: 0, image:"54"))
        ...
        //71-80
        uploadList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Power Angel", imageDescription: "Recreating Angel with Mecha.", tags: ["Mecha","Gundam","Angel","Wings", "White"], likeCount: 0, image:"71"))
        ...
        //91-100
        uploadList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Power Angel", imageDescription: "Recreating Angel with Mecha.", tags: ["Mecha","Gundam","Angel","Wings", "White"], likeCount: 0, image:"91"))
        ...
        uploadList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Auroras", imageDescription: "Female Assassin Mecha", tags: ["Assassin","Mecha","Pink","Wings"], likeCount: 0, image:"94"))
        ...
        //MARK : Profile
        profileList.append(PostClass(uploaderName: "Firdenon", imageTitle: "UMP9", imageDescription: "UMP9 from Girl's Frontline", tags: ["UMP9","Girl","Weapon"], likeCount: 0, image: "95"))
        profileList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Our Shadow", imageDescription: "Don't let our shadow the king of our mind", tags: ["shadow","dark"], likeCount: 0, image: "71"))
        profileList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Wellington", imageDescription: "Originally Personification of Gun", tags: ["Gun","Girl"], likeCount: 0, image: "94"))
        profileList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Type67", imageDescription: "Girl's Frontline Type67", tags: ["Girl's Frontline","Girl","Weapon","Gun"], likeCount: 0, image: "91"))
        profileList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Contamination", imageDescription: "Is this our future?", tags: ["Apocalypse","Gas","Mask","Uniform","Seifuku","Long Hair"], likeCount: 0, image: "45"))
        profileList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Tomoko-chan", imageDescription: "Tomoko-chan saying hi~", tags: ["Anime","Girl","Cute","Seifuku","Schoolgirl"], likeCount: 0, image: "25"))
        profileList.append(PostClass(uploaderName: "Firdenon", imageTitle: "Wings of Assassin", imageDescription: "Recreating Assassin with Gundam", tags: ["Gundam","Mecha","Wings","Assassin","Purple","Blue","Dual Weapon"], likeCount: 0, image: "54"))
    }
}
